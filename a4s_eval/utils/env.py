...
def get_celery_broker_url() -> str:
    ...
    endpoint = (os.getenv("MQ_AMQPS_ENDPOINT") if use_ssl 
    ...
    host, port = clean_endpoint.split(":", 1) if ":" in clean_endpoint else (clean_endpoint, "5671" if scheme == "amqps" else "5672")
